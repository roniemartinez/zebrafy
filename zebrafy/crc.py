...
class CRC:
    ...
    def _get_zebra_crc16(self) -> int:
        """
        Calculate Zebra CRC-16 Algorithm.

        :returns: Zebra CRC-16
        """
    ...
    def get_crc_hex_string(self) -> str:
        """
        Get Zebra CRC-16 as four digit zero padding hexadecimal string.

        :returns: Zebra CRC-16 as four digit zero padding hexadecimal string
        """
        return f"{self._get_zebra_crc16():04X}"
